...
#
# Delegates to the system-wide `claude-relay` binary rather than importing
# `claude_relay` directly, because the package is typically installed in
# an isolated venv (uv tool / pipx) that the system `python3` cannot see.
import os
import sys

EXE = os.path.expanduser("~/.local/bin/claude-relay")
if not os.path.exists(EXE):
    EXE = "claude-relay"  # fall back to PATH lookup
